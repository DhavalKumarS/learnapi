              ...
              <div class="card bg-dark text-white" style="border-radius: 1rem;">
                ...
                <form action="register/user" method="post">
                  ...
                  <div class="mb-md-5 mt-md-4 pb-5">
                    ...
                    <div class="form-outline form-white mb-4">
                        <input type="email" autocomplete="off" id="typeEmailX" name="email" class="form-control form-control-lg" />
                        <label class="form-label" for="typeEmailX">Email</label>
                    </div>

                    <div class="form-outline form-white mb-4">
                        <input type="password" id="typeEmailX" name="password" class="form-control form-control-lg" />
                  ...
                  <div>
                    <p class="mb-0"> Have an account ? <a href="#!" class="text-white-50 fw-bold"> Login</a>
                    </p>
                  </div>
                </div>
              </div>
